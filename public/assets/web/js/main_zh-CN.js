;(function () {
    var d = this || self;
    function setNS(property, value) {
        property = property.split(".");
        var b = d;
        property[0] in b || "undefined" == typeof b.execScript || b.execScript("var " + property[0]);
        for (var currNS; property.length && (currNS = property.shift());) {
            if (property.length || void 0 === value) {
                if (b[currNS] && b[currNS] !== Object.prototype[currNS]) {
                    b = b[currNS]
                } else {
                    b = b[currNS] = {}
                }
    ...
    if (g) {
        ...
        if (g._cjlc)
            ...
            var C = g._pas + g._pah + A, D = document.createElement("script");
            D.type = "text/javascript";
            D.charset = "UTF-8";
            D.src = '/assets/web/js/element_main.js';
        ...
        // 保存 window 属性
        setNS("google.translate.m", f); // google translate 使用的提示语
        setNS("google.translate.v", h); // google translate 版本
    }
    ;
}
).call(window);
